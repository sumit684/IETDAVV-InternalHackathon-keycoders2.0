                ...
                <div class="jumbotron text-center">
                    ...
                    <div class="row" style="padding:50px;">
                        ...
                        <div class="col-md-8 " align="center">
                            ...
                            <div class="row"> 
                                <div class="col-md-6"><h5>Enrollment No. :</h5></div>
                                <div class="col-md-6"><?=$value->enroll_no?></div>  
                            </div>
                            <div class="row"> 
                                <div class="col-md-6"><h5>Batch :</h5></div>
                                <div class="col-md-6"><?=$value->year_adm?>-<?=$value->year_leaving?></div>  
                            </div>
                            <div class="row"> 
                                <div class="col-md-6"><h5>Email :</h5></div>
                                <div class="col-md-6"><?=$value->email_id?></div>  
                            </div>
                            <div class="row"> 
                                <div class="col-md-6"><h5>Date of Birth :</h5></div>
                                <div class="col-md-6"><?=$value->dob?></div>  
                            </div>
                            <div class="row"> 
                                <div class="col-md-6"><h5>Occupation :</h5></div>
                                <div class="col-md-6"><?=$value->occupation?></div>  
                            </div>
                            <div class="row"> 
